...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { description: @weather.description, score: @weather.score, station_id: @weather.station_id, updated_at: @weather.updated_at } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { description: @weather.description, score: @weather.score, station_id: @weather.station_id, updated_at: @weather.updated_at } }
